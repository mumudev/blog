  ...
  <Row class="vm-table vm-panel">
    ...
    <div class="panel-body">
      ...
      <div class="edit" v-if="type === 'edit'">
        ...
        <Button :disabled="deleteDisabled" @click="modalDelete = true">
    ...
    <Modal v-model="modalAdd" title="Add" ok-text="OK" cancel-text="Cancel" v-on:on-ok="addOk">
      <Form :label-width="50">
...
export default {
  ...
  computed: {
    showColumns() {
      const showColumn = this.columns.slice();
